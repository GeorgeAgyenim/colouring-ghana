...
Note: ADR-0027 names this ticket as `01-remove-map-stack-flag.md`. It was regenerated by `/to-tickets` on
2026-09-16 as ticket 13 so that the numbering follows dependency order; the ADR is accepted and is not edited.
