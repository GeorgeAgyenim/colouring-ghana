...
export const ageLegend = [
    { color: '#ffd60a', text: '≥2020' },
    { color: '#ff8500', text: '2015-2019' },
    { color: '#ef476f', text: '2010-2014' },
    { color: '#cc1212', text: '2005-2009' },
    { color: '#8f0303', text: '2000-2004' },
    { color: '#8f5385', text: '1990-1999' },
    { color: '#6a9dba', text: '1980-1989' },
    { color: '#3b74a3', text: '1970-1979' },
    { color: '#6d8a51', text: '1957-1969' },
    { color: '#06d6a0', text: '1900-1956' },
    { color: '#d0c291', text: '<1900' },
]
...
export const categoryMapsConfig: {[key in Category]: CategoryMapDefinition[]} = {
    ...
    [Category.ConstructionDesign]: [
        ...
        },
        {
            ...
            legend: {
                title: 'Roof covering',
                elements: [
                    { color: "#b5a859", text: "Corrugated Metal Sheet" },
                    { color: "#ffffe3", text: "Concrete (Flat Roof)" },
                    { color: "#f5d96b", text: "Asbestos Sheet" },
                    { color: "#beffe8", text: "Thatch" },
                    { color: "#5c8970", text: "Roofing Tiles" },
                    { color: "#96613b", text: "Other Natural Material" },
                    { color: "#c48a85", text: "Other Man-Made Material" }
                ]
            },
    ...
    [Category.PlanningConservation]: [
        {
            ...
            legend: {
                title: 'All planning applications available from the Physical Planning Department (official data)',
                disclaimer: 'This map shows official data available from the Physical Planning Department. What you are looking at is mainly applications from 2019 onwards.',
                elements: [
    ...
    [Category.LandUse]: [
        {
            ...
            legend: {
                ...
                elements: [
                    ...
                    { color: '#f5f58f', text: 'Industrial' },
                    { color: '#73ccd1', text: 'Agricultural' },
                    { color: '#45cce3', text: 'Mining and Extractive' },
                    { color: '#b3de69', text: 'Transportation and Infrastructure' },
                    { color: '#fa667d', text: 'Public & Institutional' },
                    { color: '#ffbfbf', text: 'Recreational & Open Space' },
                    { color: '#cccccc', text: 'Conservation' },
                    { color: '#6c6f8e', text: 'Unclassified' }
                ]
            },
        },
        /*{
    ...
    [Category.RetrofitCondition]: [
        {
            mapStyle: 'building_condition',
            legend: {
                title: 'Building Condition',
                elements: [
                    { color: '#568b24ff', text: 'Excellent (Looks new or very well-maintained)' },
        ...
        {
            mapStyle: 'retrofit_condition',
            legend: {
                title: 'Retrofit Condition',
                elements: []
            }
        }
    ],
