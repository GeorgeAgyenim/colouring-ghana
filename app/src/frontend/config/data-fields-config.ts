...
export const dataFields = { /* eslint-disable @typescript-eslint/camelcase */
    ...
    location_latitude: {
        ...
        tooltip: "Latitude of building, using WGS 84 (EPSG:4326). Building geometry is reduced to a point (centroid) representing it.",
        example: 6.4564,
    },
    location_longitude: {
        category: Category.Location,
        title: "Building longitude coordinate",
        tooltip: "Longitude of building, using WGS 84 (EPSG:4326). Building geometry is reduced to a point (centroid) representing it.",
        example: -1.12124,
    },
    ...
    current_landuse_group: {
        ...
        tooltip: "Land use Groups as classified by Ghana's Land Use and Spatial Planning Act (Act 925) and related national guidelines",
        example: ["", ""],
    },
    current_landuse_order: {
        category: Category.LandUse,
        title: "This land use is shown on the map as:",
        tooltip: "Land use Order as classified by Ghana's Land Use and Spatial Planning Act (Act 925) and related national guidelines. Derived automatically from the data above.",
        example: "",
    },
    ...
    size_storeys_core: {
        ...
        tooltip: "How many floors are there between the pavement/ground and start of roof?",
        example: 10,
    },
    size_storeys_attic: {
        category: Category.ConstructionDesign,
    ...
    size_storeys_basement: {
        ...
        tooltip: "How many floors below pavement/ground level(basement)?",
        example: 1,
    },
    ...
    size_floor_area_ground: {
        ...
        example: 1245.6,
        tooltip: "The size of the building’s footprint — only the ground-level floor.",
    },
    size_floor_area_total: {
        category: Category.ConstructionDesign,
        title: "Total floor area (m²)",
        example: 2001.7,
        tooltip: "The sum of all floors inside the building (ground floor + upper floors).",
    },
    ...
    construction_structural_system: {
        ...
        items: [
            ...
            "A lateral load resisting structure (e.g. concrete, steel or wooden frame)",
            "Other"
        ]
    },
    ...
    community_activities_current: {
        ...
        tooltip: "E.g. community centre, place of worship, health clinic (e.g., CHPS compound), chop bar, or durbar ground",
        example: true
    },
    ...
    building_condition: {
        category: Category.RetrofitCondition,
        title: "What is the current physical condition of this building? (Best estimate)",
        tooltip: "Assess based on visible signs like cracks, peeling paint, structural damage, roof condition, and general maintenance.",
        example: "",
        items: [
            "Excellent (Looks new or very well-maintained)",
    ...
    building_condition_source_links: {
        category: Category.RetrofitCondition,
        title: "Source link(s)",
        tooltip: null,
        example: ["", "", ""],
    ...
    typology_style_period: {
        ...
        tooltip: null,
        example: "1874–1957 (British Colonial Era)",
        items: [
            'Pre-1400 (Indigenous Traditional Settlements)',
            '1400–1800 (Early Coastal States & Trade Era)',
            '1800–1874 (Early Colonial Influence / Forts & Castles)',
            '1874–1957 (British Colonial Era)',
            '1957–1980 (Post-Independence Modernism)',
            '1981–1999 (Late 20th Century / Structural Adjustment Era)',
            '2000–2010 (Early 21st Century Urban Expansion)',
            '2011–present (Contemporary Architecture)',
        ]
    },
