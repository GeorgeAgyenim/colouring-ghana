...
-- order
('U001','Residential','order',NULL,True),
('U002','Commercial','order',NULL,True),
('U003','Industrial','order',NULL,True),
('U004','Agricultural','order',NULL,True),
('U005','Mining and Extractive','order',NULL,True),
('U006','Transportation and Infrastructure','order',NULL,True),
('U007','Public & Institutional','order',NULL,True),
('U008','Recreational & Open Space','order',NULL,True),
('U009','Conservation','order',NULL,True),
('U010','Unclassified','order',NULL,True),
--We have created a landuse order that does not exist for mixed use
('U011','Mixed Use','order',NULL,True),

-- group
('1001','Dwelling (family house, bungalow)','group','U001', True),
('1002','Flats / apartments','group','U001', True),
('1003','Compound Housing','group','U001', True),
('1004','Private Student Hostel','group','U001', True),
('1005','Gated / Housing Estate','group','U001', True),
('1006','Social Housing','group','U001', True),
('1007','Informal Housing','group','U001', True),
('1008','Orphanage / Children’s Home','group','U001', True),
('1009','Elderly Care Facility','group','U001', True),
('1010','Retail Shop / Kiosk (shops/market stalls/small trading units)','group','U002', True),
('1011','Supermarket / Shopping Centre (supermarkets/malls/large retail complexes)','group','U002', True),
('1012','Offices, Financial & Professional Services (business/banks/corporate offices/consultancies)','group','U002', True),
('1013','Restaurant / Bar / Café (eateries/food joints/bars/fast food/canteens)','group','U002', True), -- corrected U054 to U052
('1014','Hotel / Guesthouse / Lodge','group','U002', True),
('1015','Personal Services (Salon/Barber/Tailor/Spas/Beauty shops/Fashion shops)','group','U002', True), -- corrected U051 to U054
('1016','Informal Commerce (roadside vending)','group','U002', True),
('1017','Fuel / Service Station (Petrol/LPG/EV-charging stations)','group','U002', True),
('1018','Light industry (workshops, small-scale manufacturing)','group','U003', True),
('1019','Heavy industry (big factories & major production)','group','U003', True),
('1020','Processing Plant','group','U003', True),
('1021','Recycling / Waste Facility','group','U003', True),
('1022','Brewery / Distillery','group','U003', True),
('1023','Timber Mill / Sawmill','group','U003', True),
('1024','Utility / Industrial Support (depots, storage, repair yards)','group','U003', True),
('1025','Warehouse / Distribution Centre','group','U003', True),
('1026','Hazardous / Noxious (chemicals, fuel, toxic waste)','group','U003', True),
('1027','Farmhouse','group','U004', True),
('1028','Barn / Storage (Barns, silos, general farm storage)','group','U004', True),
('1029','Agro-Processing Facility','group','U004', True),
('1030','Livestock / Animal Housing (Poultry house, cattle shed, pigsty, goat/sheep pen)','group','U004', True),
('1031','Horticultural / Nursery','group','U004', True),
('1032','Fishery / Aquaculture Facility','group','U004', True),
('1033','Farm Workshop / Utility (Mechanic shed, irrigation pump house, tractor storage)','group','U004', True),
('1034','Mineral Workings & Quarries','group','U005', True),
('1035','Bus Terminal / Lorry Station','group','U006', True),
('1036','Railway Station','group','U006', True),
('1037','Airport / Airstrip Terminal','group','U006', True),
('1038','Port / Harbour Facility','group','U006', True),
('1039','Parking Garage / Transport Depot','group','U006', True),
('1040','Telecommunication Facility','group','U006', True),
('1041','Utility Service (Power/Water/Waste)','group','U006', True),
('1042','Renewable Energy','group','U006', True),
('1043','Education & Training (school, university, TVET, apprenticeship centre)','group','U007', True),
('1044','Health Facility (clinic, hospital, CHPS compound)','group','U007', True),
('1045','Government Administration (municipal assembly, ministries, passport office, NADMO, etc.)','group','U007', True),
('1046','Security / Emergency Services (police station, fire station, immigration service, prisons service office)','group','U007', True),
('1047','Community Centre / Civic Hall (assembly hall, community centre)','group','U007', True),
('1048','Place of Worship (church, mosque, temple, shrine)','group','U007', True),
('1049','Library / Museum / Cultural Facility (gallery, cultural centre)','group','U007', True),
('1050','Cemetery / Crematoria','group','U007', True),
('1051','Embassy / Consulate','group','U007', True),
('1052','Post Office / Communication (postal services, telecom administrative offices)','group','U007', True),
('1053','Parks & Green Spaces (pavilions/shelters/offices in public parks/gardens/green areas)','group','U008', True),
('1054','Playgrounds & Sport Facilities (play structures/sports halls/stadia/swimming complexes)','group','U008', True),
('1055','Public Squares & Community Gathering (durbar grounds/plazas)','group','U008', True),
('1056','Indoor Recreation & Leisure Facilities (gym/cinema/fitness centre/indoor sports hall)','group','U008', True),
('1057','Forest Reserve / Protected Woodland','group','U009', True),
('1058','Wetland / Riparian','group','U009', True),
('1059','Historical / Cultural Heritage Site (monument, fort, castle)','group','U009', True),
('1060','Nature Reserve / Sanctuary','group','U009', True),
('1061','Conservation Buffer','group','U009', True),
('1062','Unclassified','group','U010', True);
